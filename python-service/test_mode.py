...
def create_mock_model():
    """Create and save a mock model for testing using Hugging Face format"""
    ...
    try:
        ...
        # Use a pre-trained BERT model as a mock
        logger.info("Downloading pre-trained BERT model for testing...")
